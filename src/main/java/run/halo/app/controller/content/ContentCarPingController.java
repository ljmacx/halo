...
@Slf4j
@Controller
@RequestMapping("/carping")
public class ContentCarPingController {
    private final PostService postService;
    private final OptionService optionService;
    private final ThemeService themeService;
    private final CategoryService categoryService;

    public ContentCarPingController(PostService postService,
    ...
    @GetMapping
    public String carpingIndex(Model model) {
    ...
    public String index(Model model,
        ...
        Category category = categoryService.getByName("carping");
