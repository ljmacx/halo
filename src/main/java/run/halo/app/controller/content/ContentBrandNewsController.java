...
public class ContentBrandNewsController {
    private final PostService postService;
    private final OptionService optionService;
    private final ThemeService themeService;
    private final CategoryService categoryService;

    public ContentBrandNewsController(PostService postService,
    ...
    @GetMapping
    public String brandNewsIndex(Model model) {
    ...
    public String index(Model model,
        ...
        Category category = categoryService.getByName("brandNews");
