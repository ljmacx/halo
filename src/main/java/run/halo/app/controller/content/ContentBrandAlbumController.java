...
public class ContentBrandAlbumController {
    ...
    public ContentBrandAlbumController(PostService postService,
     ...
     */
    @GetMapping
    public String archives(Model model, @PathParam(value = "bId") Integer bId) {
        return this.archives(model, bId, 1, Sort.by(DESC, "createTime"));
    }
    ...
    public String archives(Model model,
        ...
        query.setBrandId(bId);
        CarBrand brand = carBrandService.getById(bId);
        ...
        return themeService.render("album");
    }
