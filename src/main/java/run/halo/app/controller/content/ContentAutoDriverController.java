...
@Slf4j
@Controller
@RequestMapping("/autodriver")
public class ContentAutoDriverController {
    private final PostService postService;
    private final OptionService optionService;
    private final ThemeService themeService;
    private final CategoryService categoryService;

    public ContentAutoDriverController(PostService postService,
    ...
    @GetMapping
    public String autoDriverIndex(Model model) {
    ...
    public String index(Model model,
        ...
        Category category = categoryService.getByName("autoDriver");
